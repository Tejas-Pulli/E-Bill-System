...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if (!empty($user_name) && !empty($password) && !is_numeric($user_name)) {
		...
		//read from database
		$query = "select * from a_users where user_name = '$user_name' limit 1";
								...
								<div class="card-body p-5 text-center">
									...
									<div class="mb-md-5 mt-md-4 pb-5">
										...
										<div class="form-outline form-white mb-4">
											<input type="text" id="text" name="user_name" class="form-control form-control-lg" />
										...
										<!-- <input id="button" class="btn btn-outline-light btn-lg px-5" type="submit">Login</input> -->
										<button id="button" class="btn btn-outline-light btn-lg px-5" type="submit">Login</button>
										<!-- <button id="button" class="btn btn-outline-light btn-lg px-5" type="submit">Login</button> -->
										<!-- <a href="/Final/backend/home/" >Home</a> -->
										<!-- <form method="POST" action="/Final/backend/home/"> <input type="submit" value="open" /> -->

									</div>

									<div>
										<p class="mb-0">Don't have an account? <a href="a_signup.php" class="text-white-50 fw-bold">Sign up
											</a>
