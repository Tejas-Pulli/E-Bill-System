...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($user_name) && !empty($password) && !is_numeric($user_name))
		{
			...
			$query = "insert into a_users (user_id,user_name,password) values ('$user_id','$user_name','$password')";
...
<!-- 
                                ...
                                <button id="button" class="btn btn-outline-light btn-lg px-5" type="submit">Signup</button>

                            </div>

                            <div>
                                <p class="mb-0">Already have an account? <a href="a_login.php" class="text-white-50 fw-bold">Login
                                        </a>
                                </p>
                            </div>
